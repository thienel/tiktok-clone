namespace TikTokClone.Application.Constants
{
    public static class ErrorCodes
    {
        ...
        public const string INVALID_AVATAR_URL = "INVALID_AVATAR_URL";
        public const string INVALID_BIO_LENGTH = "INVALID_BIO_LENGTH";
        public const string USER_ARGUMENT_NULL = "USER_ARGUMENT_NULL";
